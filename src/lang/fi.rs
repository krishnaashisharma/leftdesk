...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään LeftDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa LeftDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi LeftDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava LeftDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava LeftDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten LeftDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota LeftDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli LeftDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "LeftDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa LeftDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "LeftDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep LeftDesk background service", "Pidä LeftDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista LeftDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_leftdesk_password_tip", "Vahvista LeftDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "LeftDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_leftdesk_server_pro_to_{}_tip", "Päivitä LeftDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About LeftDesk", "Tietoa LeftDeskistä"),
        ...
        ("upgrade_remote_leftdesk_client_to_{}_tip", "Päivitä etä-LeftDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
