...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua LeftDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca LeftDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala LeftDesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți LeftDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți LeftDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți LeftDesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [LeftDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep LeftDesk background service", "Rulează serviciul LeftDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației LeftDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show LeftDesk", "Afișează LeftDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi LeftDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi LeftDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din LeftDesk care rulează."),
        ...
        ("verify_leftdesk_password_tip", "Verifică parola LeftDesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi LeftDesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_leftdesk_server_pro_{}_tip", "Versiunea serverului LeftDesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul LeftDesk pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu LeftDesk"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web LeftDesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări LeftDesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About LeftDesk", "Despre LeftDesk"),
        ...
        ("web_id_input_tip", "Introdu ID-ul LeftDesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_leftdesk_client_to_{}_tip", "Versiunea clientului LeftDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește LeftDesk Pro pentru funcționalitate completă."),
