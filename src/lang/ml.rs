...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "സെറ്റിംഗ്സിൽ LeftDesk കണ്ടെത്തി അത് ഓൺ ചെയ്യുക."),
        ...
        ("Language", "ഭാഷ"),
        ("Keep LeftDesk background service", "LeftDesk ബാക്ക്ഗ്രൗണ്ടിൽ പ്രവർത്തിപ്പിക്കുക"),
        ...
        ("Show LeftDesk", "LeftDesk കാണിക്കുക"),
        ("This PC", "ഈ പിസി"),
        ("or", "അല്ലെങ്കിൽ"),
        ...
        ("verify_leftdesk_password_tip", "LeftDesk പാസ്‌വേഡ് പരിശോധിക്കുക"),
        ...
        ("scam_text1", "നിങ്ങൾക്ക് പരിചയമില്ലാത്ത ആരെങ്കിലും LeftDesk ഉപയോഗിക്കാൻ ആവശ്യപ്പെട്ടാൽ ഉടൻ കണക്ഷൻ വിച്ഛേദിക്കുക."),
        ...
        ("upgrade_leftdesk_server_pro_to_{}_tip", "സെർവർ പ്രോ {} ലേക്ക് അപ്‌ഗ്രേഡ് ചെയ്യുക"),
        ...
        ("allow-only-conn-window-open-tip", "LeftDesk വിൻഡോ തുറന്നിരിക്കുമ്പോൾ മാത്രം കണക്ഷൻ അനുവദിക്കുക"),
        ...
        ("floating_window_tip", "ബാക്ക്ഗ്രൗണ്ടിലാണെങ്കിലും LeftDesk കാണിക്കുക"),
        ...
        ("About LeftDesk", "LeftDesk-നെ കുറിച്ച്"),
        ...
        ("upgrade_remote_leftdesk_client_to_{}_tip", "റിമോട്ട് പതിപ്പ് {} ലേക്ക് മാറ്റുക"),
