...
lazy_static::lazy_static! {
    ...
    // https://github.com/leftdesk/leftdesk/issues/13705
...
/// See issue: https://github.com/leftdesk/leftdesk/issues/9003
...
// stop_leftdesk_servers() is just a temp solution here.
fn force_stop_server() {
    stop_leftdesk_servers();
...
pub fn start_os_service() {
    ...
    while running.load(Ordering::SeqCst) {
        ...
        if keeps_headless || keeps_session {
            // for fixing https://github.com/leftdesk/leftdesk/issues/3129 to avoid too much dbus calling,
            sleep_millis(500);
        } else {
            sleep_millis(super::SERVICE_INTERVAL);
        }
...
pub fn is_locked() -> bool {
    ...
    // https://github.com/leftdesk/hbb_common/blob/ebb4d4a48cf7ed6ca62e93f8ed124065c6408536/src/platform/linux.rs#L119
    if values.is_empty() {
...
///
/// https://github.com/leftdesk/leftdesk/discussions/11959
///
...
mod desktop {
    ...
    pub struct Desktop {
        ...
        pub home: String,
        pub dbus: String,
        pub is_leftdesk_subprocess: bool,
    ...
    impl Desktop {
        ...
        pub fn is_headless(&self) -> bool {
            self.sid.is_empty() || self.is_leftdesk_subprocess
        }
        ...
        fn set_is_subprocess(&mut self) {
            self.is_leftdesk_subprocess = false;
            let cmd = format!(
            ...
            if let Ok(res) = run_cmds(&cmd) {
                if res.trim() != "0" {
                    self.is_leftdesk_subprocess = true;
                }
            }
        }
...
pub fn uninstall_service(show_new_window: bool, _: bool) -> bool {
    ...
    // systemctl kill leftdesk --tray, execute cp first
...
pub fn check_autostart_config() -> ResultType<()> {
    ...
    // https://github.com/leftdesk/leftdesk/issues/4863
...
fn get_shortcuts_inhibitor_app_id() -> String {
    if is_flatpak() {
        ...
        // (e.g., "com.leftdesk.LeftDesk"). This is the most reliable source.
