...
///
/// Note:
/// On linux, we use dbus to communicate multiple leftdesk process.
...
const DBUS_NAME: &str = "org.leftdesk.leftdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "LeftDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.leftdesk.leftdesk /dbus org.leftdesk.leftdesk.NewConnection string:'PEER_ID'`
