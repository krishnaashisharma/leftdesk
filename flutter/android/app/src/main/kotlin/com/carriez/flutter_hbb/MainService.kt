...
const val DEFAULT_NOTIFY_TITLE = "LeftDesk"
...
class MainService : Service() {
    ...
    private val wakeLock: PowerManager.WakeLock by lazy { powerManager.newWakeLock(PowerManager.ACQUIRE_CAUSES_WAKEUP or PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "leftdesk:wakelock")}
    ...
    override fun onDestroy() {
        ...
        // FloatingWindowService disabled
        super.onDestroy()
    }
    ...
    private fun initNotification() {
        ...
        notificationChannel = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "LeftDesk"
            val channelName = "LeftDesk Service"
            val channel = NotificationChannel(
                channelId,
                channelName, NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "LeftDesk Service Channel"
            }
