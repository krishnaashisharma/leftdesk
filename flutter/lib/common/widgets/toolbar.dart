...
List<TTextMenu> toolbarControls(BuildContext context, String id, FFI ffi) {
  ...
  // https://github.com/leftdesk/leftdesk/pull/9731
...
bool showVirtualDisplayMenu(FFI ffi) {
  ...
  if (ffi.ffiModel.pi.isLeftDeskIdd || ffi.ffiModel.pi.isAmyuniIdd) {
    return true;
  }
  return false;
}
...
List<Widget> getVirtualDisplayMenuChildren(
  ...
  if (pi.isLeftDeskIdd) {
    final virtualDisplays = ffi.ffiModel.pi.LeftDeskVirtualDisplays;
