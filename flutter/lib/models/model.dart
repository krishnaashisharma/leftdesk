...
class FfiModel with ChangeNotifier {
  ...
  bool shouldAutoRetryOnOffline(
    ...
    if (type == 'error' &&
      ...
      // https://github.com/leftdesk/leftdesk/discussions/14048
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsLeftDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsLeftDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsLeftDeskVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/leftdesk/leftdesk/pull/3706#issuecomment-1481242389
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get LeftDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsLeftDeskVirtualDisplays] ?? []);
  ...
  bool get isLeftDeskIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'leftdesk_idd';
